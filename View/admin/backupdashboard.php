                        ...
                        <div class="col-sm-4 align-self-center">
                            <!-- <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div class="stat text-primary">
                                                <i class="icon-dashboard ic-pembayaran"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <h1 class="mt-1 mb-3">
                                        4 <span class="text-muted fs-4">Metode Aktif</span>
                                    </h1>
                                    <div class="mb-0">
                                        <a href="" class="nav-link color-third d-sm-inline-block"><span>Selengkapnya</span>
                                            <li data-feather="chevron-right"></li>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <!-- <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">Kelola</h5>
                                        </div>
                                        <div class="col-auto">
                                            <div class="stat text-primary">
                                                <i class="icon-dashboard ic-map"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <h2 class="mt-1 mb-3">Radius Pembayaran</h2>
                                    <div class="mb-0">
                                        <a href="" class="nav-link color-third d-sm-inline-block"><span>Selengkapnya</span>
                                            <li data-feather="chevron-right"></li>
                                        </a>
                            ...
                            <!-- <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div class="stat text-primary">
                                                <i class="icon-dashboard ic-bantuan"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <h1 class="mt-1 mb-3">Bantuan</h1>
                                    <div class="mb-0">
                                        <a href="" class="nav-link color-third d-sm-inline-block"><span>Selengkapnya</span>
                                            <li data-feather="chevron-right"></li>
                                        </a>
                            ...
                            <!-- <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div class="stat text-primary">
                                                <i class="icon-dashboard ic-riwayat"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <h2 class="mt-1 mb-3">Riwayat Pembaruan</h2>
                                    <div class="mb-0">
                                        <a href="index.php?page=riwayatPembaruan&aksi=view" class="nav-link color-third d-sm-inline-block"><span>Selengkapnya</span>
                                            <li data-feather="chevron-right"></li>
                                        </a>
                                    </div>
                                </div>
