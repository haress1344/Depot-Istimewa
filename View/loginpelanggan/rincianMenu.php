...
<head>
    ...
    <!-- CSS Custom -->
    <link rel="stylesheet" href="assets/css/styleku.css?=8" />
    <!-- icon -->
                            ...
                            <div class="container">
                                ...
                                <form action="index.php?page=keranjang&aksi=storeItem" method="post">
                                    <div class="d-grid gap-2">
                                        <input name="id_produk" type="hidden" value="<?= $produk[0]["id_produk"] ?>">
                                        <input name="id_kategori" type="hidden" value="<?= $produk[0]["id_kategori"] ?>">
                                        <button
                                            type="submit"
                                            class="btn color-primary-button ps-4 pe-4 mb-3">Pesan</button>
                                    </div>
                                </form>
                            </div>
                        </div>
