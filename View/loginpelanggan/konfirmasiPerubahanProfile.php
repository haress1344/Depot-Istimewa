        ...
        <div class="container">
            <div class="row justify-content-around">
                ...
                <div class="col-lg-7">
                    ...
                    <form action="index.php?page=pelanggan&aksi=updateProfile" method="post">
                        <div class="mb-3">
                            <input name="nama" type="hidden" class="form-control" value="<?= $dataProfile["nama"] ?>" />
                        </div>
                        <div class="mb-3">
                            <input name="email" type="hidden" class="form-control" value="<?= $dataProfile["email"] ?>" />
                        </div>
                        <div class="mb-3">
                            <input name="noHp" type="hidden" class="form-control" value="<?= $dataProfile["noHp"] ?>" />
                        </div>
                        <div class="mb-3">
                            <input name="alamat" type="hidden" class="form-control" value="<?= $dataProfile["alamat"] ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="konfirmPass" class="form-label">Konfirmasi Password</label>
                            <input name="konfirmPass" type="password" class="form-control" id="konfirmPass" />
                        </div>
