                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="card pb-4 card-secondary">
                            ...
                            <hr class="ms-3 me-3" />
                            <form action="index.php?page=ulasan&aksi=storeEditTanggapan" method="post">
                                <div class="card ms-3 me-3">
                                    <div class="card-body">
                            
                                        <input type="hidden" name="id_produk" id="" value="<?= $_GET["pdk"] ?>">
                                        <input type="hidden" name="id_tanggapan" id="" value="<?= $tanggapan["id_tanggapan"] ?>">
                                        <div class="mb-3">
                                            ...
                                            <textarea
                                                ...
                                                class="form-control"
                                                type="text"
                                                id="tanggapiulasan" required><?=$tanggapan["ket_tanggapan"]?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="container">
                                    <div class="d-grid gap-2 d-md-block mt-5 mb-3">
                                        ...
                                        <button
                                            type="submit"
                                            class="btn fs-3 fw-bold color-primary-button ms-2 pt-0 pb-0 ps-5 pe-5">
                                            Edit
                                        </button>
                                    </div>
                                </div>
