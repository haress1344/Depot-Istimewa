        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="mb-3 color-secondary"><strong>Tambah Produk</strong></h1>
                    <div class="card flex-fill">
                        <div class="card-body card-secondary">
                            <div class="container">
                                <form action="index.php?page=kelolaproduk&aksi=storeproduk&idkategori=<?= $_GET["idkategori"] ?>" method="post" enctype="multipart/form-data">
                                    <!-- form email-konfirmasi pass -->
                                    <div class="mb-3">
                                        <input name="idkategori" type="hidden" class="form-control" id="idkategori" value="<?= $_GET["idkategori"] ?>" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="jmlstok" type="number" class="form-control" id="jumlahstok" />
                                    </div>
                                    <label for="hargaproduk" class="form-label">*Harga Produk</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="rupiah">Rp</span>
                                        <input name="hargaproduk" type="number" class="form-control" id="hargaproduk" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="ketproduk" class="form-control" type="file" id="ketproduk"></textarea>
                                    </div>

                                    <div class="d-grid gap-2 d-md-block mt-5 mb-3">
                                        <a href="index.php?page=kelolaproduk&aksi=view&idkategori=<?= $_GET["idkategori"] ?>" type="button" class="btn color-secondary-button fs-3 fw-bold ms-2 pt-0 pb-0 ps-4 pe-4">Kembali</a>
