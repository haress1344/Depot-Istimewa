...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <!-- konten Perbarui Kategori Menu -->
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="mb-3 color-secondary">
                        <strong>Perbarui Kategori Produk</strong>
                    </h1>
                    <div class="card flex-fill">
                        <div class="card-body card-secondary p-4">
                            <div class="container">
                                <form action="index.php?page=kelolakategori&aksi=storeubahkategori&idkategori=<?= $kategoriLama["id_kategori"] ?>" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name=gambarkategori class="form-control" value="<?= $kategoriLama["gambar_kategori"] ?>" />
                                    <div class="mb-3">
                                        <label for="namakategori" class="form-label">Nama Kategori</label>
                                        <input name="namakategori" type="text" class="form-control" id="namakategori" value="<?= $kategoriLama["nama_kategori"] ?>" />
                                    </div>
                                    <div class="mb-3">

                                        <label class="mb-2">Pilih Icon Kategori</label>

                                        <?php foreach ($iconLama as $row) : ?>
                                            <div class="form-check pb-2">
                                                <input name="id_icon" class="form-check-input ms-1 " type="radio"
                                                    value="<?= $row["id_icon"] ?>" <?= ($row["id_icon"] == $kategoriLama["id_icon"]) ? "checked" : "" ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img src="assets/img/<?= $kategoriLama["gambar_kategori"] ?>" width="100" alt="" class="mb-2" />
                                        <label for="gambarkategori" class="form-label"></label>
                                        <input name="gambarkategori" class="form-control" type="file" id="gambarkategori" />
                                    </div>

                                    <div class="d-grid gap-2 d-md-block mt-5 mb-1">
                                        ...
                                        <button type="submit" class="btn fs-4 fw-bold color-primary-button ms-2 pt-1 pb-1 ps-4 pe-4">
                                            Simpan Perubahan
                                        </button>
                                    </div>
                                </form>
            ...
            <!-- akhir konten Perbarui kategori menu -->
            <!-- footer -->
